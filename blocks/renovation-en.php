...
<section class="content-section hero-surface">
    <div class="content-container">
        <div class="content-hero-card" style="background: linear-gradient(270deg, rgba(0, 0, 0, 0.25) 0%, rgba(0, 0, 0, 0.78) 100%), url('/assets/img/wp14994047-valencia-4k-wallpapers.png'); background-size: cover; background-position: center;">
            <div class="content-pill">Renovation in Valencia</div>
            <h1 style="color: #fff; font-size: clamp(28px, 4vw, 42px); font-weight: 800; line-height: 1.2; margin: 0;">Quality Renovation of Apartments and Houses in Valencia</h1>
            <p class="content-lead">Full cycle renovation services — from design project to final cleaning. European quality materials, transparent pricing, and strict deadline compliance.</p>
            <div style="display: flex; gap: 24px; flex-wrap: wrap; margin-top: 8px;">
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <span style="font-weight: 600;">2 Year Warranty</span>
                </div>
                <div style="display: flex; align-items: center; gap: 10px;">
                    <div style="width: 40px; height: 40px; background: rgba(255,255,255,0.15); border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                ...
                <div style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <span style="font-weight: 600;">Experienced Craftsmen</span>
                </div>
            </div>
            <div style="display: flex; gap: 16px; flex-wrap: wrap; margin-top: 16px;">
                <a href="#calculator" class="btn btn-large" style="text-decoration: none;">Calculate Cost</a>
                <a href="#callback" class="btn btn-large" style="background: rgba(255,255,255,0.15); border: 2px solid rgba(255,255,255,0.4); text-decoration: none;">Get Consultation</a>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section" id="calculator">
    <div class="content-container">
        <div class="section-title" style="color: #60724F; text-align: center; margin-bottom: 8px;">Online Renovation Calculator</div>
        <div class="section-subtitle" style="text-align: center; margin-bottom: 32px;">
            Calculate the estimated cost of renovation in just a few clicks
        </div>
        ...
        <div class="calc-wrapper" style="background: #fff; border-radius: 24px; padding: clamp(24px, 4vw, 40px); box-shadow: 0 8px 32px rgba(0,0,0,0.08); border: 1px solid #e7ebdf;">
            <!-- Property Type Tabs -->
            <div class="calc-label" style="font-weight: 600; color: #333; margin-bottom: 12px;">Select property type</div>
            <div class="calc-tabs" style="display: flex; gap: 12px; flex-wrap: wrap; margin-bottom: 24px;">
                <button type="button" class="calc-tab active" data-tab="room" style="padding: 12px 24px; border-radius: 100px; border: 2px solid #60724F; background: #60724F; color: #fff; font-weight: 600; cursor: pointer; transition: all 0.3s ease;">Room</button>
                <button type="button" class="calc-tab" data-tab="apartment" style="padding: 12px 24px; border-radius: 100px; border: 2px solid #60724F; background: transparent; color: #60724F; font-weight: 600; cursor: pointer; transition: all 0.3s ease;">Apartment</button>
                <button type="button" class="calc-tab" data-tab="newbuild" style="padding: 12px 24px; border-radius: 100px; border: 2px solid #60724F; background: transparent; color: #60724F; font-weight: 600; cursor: pointer; transition: all 0.3s ease;">New Build</button>
            </div>
            ...
            <div class="calc-panel active" id="panel-room">
                <div class="calc-row" style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
                    <div class="calc-field">
                        <label class="calc-label" style="display: block; font-weight: 600; color: #333; margin-bottom: 8px;">Room type</label>
                        <select id="room-type" class="calc-select" style="width: 100%; padding: 14px 16px; border-radius: 12px; border: 1px solid #ddd; background: #f8f9f5; font-size: 16px; color: #333; cursor: pointer;">
                            <option value="living" data-mult="1">Living room</option>
                            <option value="kitchen" data-mult="1.2">Kitchen</option>
                            <option value="bathroom" data-mult="1.5">Bathroom</option>
                            <option value="toilet" data-mult="1.3">Toilet</option>
                            <option value="combined" data-mult="1.6">Combined bathroom</option>
                        </select>
                    </div>
                    <div class="calc-field">
                        <label class="calc-label" style="display: block; font-weight: 600; color: #333; margin-bottom: 8px;">Area, m²</label>
            ...
            <div class="calc-panel" id="panel-apartment" style="display: none;">
                <div class="calc-field" style="margin-bottom: 16px;">
                    <label class="calc-label" style="display: block; font-weight: 600; color: #333; margin-bottom: 12px;">Number of rooms</label>
                    <div class="calc-rooms" style="display: flex; gap: 8px; flex-wrap: wrap;">
                        <button type="button" class="calc-room-btn active" data-rooms="0" data-area="35" style="padding: 10px 18px; border-radius: 100px; border: 2px solid #60724F; background: #60724F; color: #fff; font-weight: 600; cursor: pointer; transition: all 0.3s ease;">Studio</button>
            ...
            <div class="calc-panel" id="panel-newbuild" style="display: none;">
                <div class="calc-field" style="margin-bottom: 16px;">
                    ...
                    <div class="calc-rooms-new" style="display: flex; gap: 8px; flex-wrap: wrap;">
                        <button type="button" class="calc-room-btn-new active" data-rooms="0" data-area="40" style="padding: 10px 18px; border-radius: 100px; border: 2px solid #60724F; background: #60724F; color: #fff; font-weight: 600; cursor: pointer; transition: all 0.3s ease;">Studio</button>
                ...
                <div class="calc-row" style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                    ...
                    <div class="calc-field">
                        <label class="calc-label" style="display: block; font-weight: 600; color: #333; margin-bottom: 8px;">Condition</label>
                        <select id="newbuild-state" class="calc-select" style="width: 100%; padding: 14px 16px; border-radius: 12px; border: 1px solid #ddd; background: #f8f9f5; font-size: 16px; color: #333; cursor: pointer;">
                            <option value="finished" data-mult="0.8">Developer finished</option>
                            <option value="rough" data-mult="1">Rough finish</option>
                            <option value="shell" data-mult="1.2">Shell condition</option>
                            <option value="openplan" data-mult="1.4">Open plan</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="calc-row" style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-top: 16px; align-items: start;">
                <div class="calc-field">
                    <label class="calc-label" style="display: block; font-weight: 600; color: #333; margin-bottom: 8px;">Renovation type</label>
                    <select id="renovation-type" class="calc-select" style="width: 100%; padding: 14px 16px; border-radius: 12px; border: 1px solid #ddd; background: #f8f9f5; font-size: 16px; color: #333; cursor: pointer;">
                        <option value="cosmetic" data-price="150" data-materials="50" data-days="0.3">Cosmetic renovation</option>
                        <option value="capital" data-price="350" data-materials="120" data-days="0.6">Full renovation</option>
                        <option value="euro" data-price="500" data-materials="180" data-days="1">Turnkey renovation</option>
                    </select>
                </div>
                <div class="calc-description" style="background: #f8f9f5; border-radius: 12px; padding: 16px; border: 1px solid #e7ebdf;">
                    <p id="renovation-desc" style="margin: 0; color: #555; font-size: 14px; line-height: 1.5;"><strong>Cosmetic renovation</strong> — finishing update without major changes: painting, floor replacement, ceiling renovation.</p>
                </div>
            </div>
            ...
            <div class="calc-results" style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 16px; margin-top: 32px; padding-top: 32px; border-top: 1px solid #e7ebdf;">
                <div class="calc-result-item" style="text-align: center; padding: 20px; background: linear-gradient(135deg, rgba(96, 114, 79, 0.05) 0%, rgba(96, 114, 79, 0.1) 100%); border-radius: 16px;">
                    <div style="font-size: 14px; color: #666; margin-bottom: 8px;">Renovation cost</div>
                    <div id="result-cost" style="font-size: clamp(24px, 3vw, 32px); font-weight: 800; color: #60724F;">2,250 EUR</div>
                </div>
                <div class="calc-result-item" style="text-align: center; padding: 20px; background: linear-gradient(135deg, rgba(96, 114, 79, 0.05) 0%, rgba(96, 114, 79, 0.1) 100%); border-radius: 16px;">
                    <div style="font-size: 14px; color: #666; margin-bottom: 8px;">Materials cost</div>
                    <div id="result-materials" style="font-size: clamp(24px, 3vw, 32px); font-weight: 800; color: #60724F;">750 EUR</div>
                </div>
                <div class="calc-result-item" style="text-align: center; padding: 20px; background: linear-gradient(135deg, rgba(96, 114, 79, 0.05) 0%, rgba(96, 114, 79, 0.1) 100%); border-radius: 16px;">
                    <div style="font-size: 14px; color: #666; margin-bottom: 8px;">Estimated time</div>
                    <div id="result-days" style="font-size: clamp(24px, 3vw, 32px); font-weight: 800; color: #60724F;">5 days</div>
                </div>
            </div>

            <p style="text-align: center; color: #888; font-size: 13px; margin-top: 16px;">* This is an estimate. For an accurate quote, request a free site visit.</p>

            <!-- CTA Form -->
            <div class="calc-cta" style="display: flex; gap: 16px; margin-top: 24px; flex-wrap: wrap;">
                <input type="tel" id="calc-phone" placeholder="Your phone" style="flex: 1; min-width: 200px; padding: 16px 20px; border-radius: 100px; border: 1px solid #ddd; background: #f8f9f5; font-size: 16px;">
                <button type="button" id="calc-submit" class="btn btn-large" style="white-space: nowrap;">Order renovation</button>
            </div>
        </div>
    </div>
</section>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const descriptions = {
        cosmetic: '<strong>Cosmetic renovation</strong> — finishing update without major changes: painting, floor replacement, ceiling renovation.',
        capital: '<strong>Full renovation</strong> — complete replacement of utilities, wall and floor leveling, new electrical and plumbing systems.',
        euro: '<strong>Turnkey renovation</strong> — complete finishing from demolition to furnishing, including design project and all types of work.'
    };
    ...
    function calculateCost() {
        ...
        document.getElementById('result-cost').textContent = totalCost.toLocaleString('en-US') + ' EUR';
        document.getElementById('result-materials').textContent = totalMaterials.toLocaleString('en-US') + ' EUR';
        document.getElementById('result-days').textContent = totalDays + ' days';
    }
...
<section class="content-section">
    <div class="content-container">
        <div class="section-title" style="color: #60724F; text-align: center; margin-bottom: 8px;">Our Services</div>
        <div class="section-subtitle" style="text-align: center; margin-bottom: 24px;">
            We perform all types of renovation work — from cosmetic updates to complete reconstruction
        </div>
        <div class="content-grid">
            <div class="content-card">
                ...
                <p>Development of individual design project with 3D visualization. Selection of materials, furniture and decor in a unified style.</p>
                <div style="margin-top: 12px; padding-top: 12px; border-top: 1px solid rgba(96, 114, 79, 0.15);">
                    <span style="color: #60724F; font-weight: 700;">from 25 EUR/m²</span>
                </div>
            </div>
            <div class="content-card">
                <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 12px;">
                    ...
                    <h3 style="margin: 0;">Cosmetic Renovation</h3>
                </div>
                <p>Finishing update without major changes: wall painting, floor replacement, ceiling renovation.</p>
                <div style="margin-top: 12px; padding-top: 12px; border-top: 1px solid rgba(96, 114, 79, 0.15);">
                    <span style="color: #60724F; font-weight: 700;">from 150 EUR/m²</span>
                </div>
            </div>
            <div class="content-card">
                <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 12px;">
                    ...
                    <h3 style="margin: 0;">Full Renovation</h3>
                </div>
                <p>Complete replacement of utilities, replanning, wall and floor leveling, new electrical and plumbing systems.</p>
                <div style="margin-top: 12px; padding-top: 12px; border-top: 1px solid rgba(96, 114, 79, 0.15);">
                    <span style="color: #60724F; font-weight: 700;">from 350 EUR/m²</span>
                </div>
            </div>
            <div class="content-card">
                <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 12px;">
                    ...
                    <h3 style="margin: 0;">Turnkey Renovation</h3>
                </div>
                <p>Complete solution: from project to furnishing. You receive a home fully ready for living.</p>
                <div style="margin-top: 12px; padding-top: 12px; border-top: 1px solid rgba(96, 114, 79, 0.15);">
                    <span style="color: #60724F; font-weight: 700;">from 500 EUR/m²</span>
                </div>
            </div>
            <div class="content-card">
                <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 12px;">
                    ...
                    <h3 style="margin: 0;">Plumbing Works</h3>
                </div>
                <p>Pipe installation and replacement, plumbing fixtures installation, appliance connection, bathroom renovation.</p>
                <div style="margin-top: 12px; padding-top: 12px; border-top: 1px solid rgba(96, 114, 79, 0.15);">
                    <span style="color: #60724F; font-weight: 700;">on request</span>
                </div>
            </div>
            <div class="content-card">
                <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 12px;">
                    ...
                    <h3 style="margin: 0;">Electrical Work</h3>
                </div>
                <p>Complete rewiring, outlet and switch installation, lighting installation, smart home systems.</p>
                <div style="margin-top: 12px; padding-top: 12px; border-top: 1px solid rgba(96, 114, 79, 0.15);">
                    <span style="color: #60724F; font-weight: 700;">on request</span>
                </div>
            </div>
...
<section class="content-section muted">
    <div class="content-container">
        <div class="section-title" style="color: #60724F; text-align: center; margin-bottom: 8px;">We Work With All Property Types</div>
        <div class="section-subtitle" style="text-align: center; margin-bottom: 24px;">
            Experience working with various types of real estate in the Valencia region
        </div>
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 16px;">
            <div class="object-card" style="background: #fff; border-radius: 16px; padding: 24px; text-align: center; box-shadow: 0 4px 16px rgba(0,0,0,0.06); border: 1px solid #e7ebdf; transition: transform 0.3s ease, box-shadow 0.3s ease;">
                ...
                <h4 style="margin: 0 0 8px; color: #333;">Apartments</h4>
                <p style="margin: 0; color: #666; font-size: 14px;">Studios, apartments, penthouses of any size</p>
            </div>
            <div class="object-card" style="background: #fff; border-radius: 16px; padding: 24px; text-align: center; box-shadow: 0 4px 16px rgba(0,0,0,0.06); border: 1px solid #e7ebdf; transition: transform 0.3s ease, box-shadow 0.3s ease;">
                <div style="width: 64px; height: 64px; background: linear-gradient(135deg, #60724F 0%, #7a8f63 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 16px;">
                ...
                <h4 style="margin: 0 0 8px; color: #333;">Villas & Houses</h4>
                <p style="margin: 0; color: #666; font-size: 14px;">Private homes, townhouses, villas with pool</p>
            </div>
            <div class="object-card" style="background: #fff; border-radius: 16px; padding: 24px; text-align: center; box-shadow: 0 4px 16px rgba(0,0,0,0.06); border: 1px solid #e7ebdf; transition: transform 0.3s ease, box-shadow 0.3s ease;">
                <div style="width: 64px; height: 64px; background: linear-gradient(135deg, #60724F 0%, #7a8f63 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 16px;">
                ...
                <h4 style="margin: 0 0 8px; color: #333;">Commercial</h4>
                <p style="margin: 0; color: #666; font-size: 14px;">Offices, shops, restaurants, hotels</p>
            </div>
            <div class="object-card" style="background: #fff; border-radius: 16px; padding: 24px; text-align: center; box-shadow: 0 4px 16px rgba(0,0,0,0.06); border: 1px solid #e7ebdf; transition: transform 0.3s ease, box-shadow 0.3s ease;">
                <div style="width: 64px; height: 64px; background: linear-gradient(135deg, #60724F 0%, #7a8f63 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 16px;">
                ...
                <h4 style="margin: 0 0 8px; color: #333;">New Buildings</h4>
                <p style="margin: 0; color: #666; font-size: 14px;">Finishing from scratch in new residential complexes</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section">
    <div class="content-container">
        <div class="section-title" style="color: #60724F; text-align: center; margin-bottom: 8px;">Why Choose Us</div>
        <div class="section-subtitle" style="text-align: center; margin-bottom: 24px;">
            We work according to European quality standards with full transparency at every stage
        </div>
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px;">
            <div class="benefit-card" style="background: linear-gradient(135deg, rgba(96, 114, 79, 0.03) 0%, rgba(96, 114, 79, 0.08) 100%); border-radius: 20px; padding: 24px; border: 1px solid rgba(96, 114, 79, 0.15);">
                <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 16px;">
                    ...
                    <h4 style="margin: 0; font-size: 18px; font-weight: 700; color: #333;">Transparent Pricing</h4>
                </div>
                <p style="margin: 0; color: #555; line-height: 1.6;">We fix the price in the contract. Detailed estimate without hidden fees. You know exactly what you're paying for at every stage.</p>
            </div>
            <div class="benefit-card" style="background: linear-gradient(135deg, rgba(96, 114, 79, 0.03) 0%, rgba(96, 114, 79, 0.08) 100%); border-radius: 20px; padding: 24px; border: 1px solid rgba(96, 114, 79, 0.15);">
                <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 16px;">
                    <div style="width: 52px; height: 52px; background: linear-gradient(135deg, #60724F 0%, #7a8f63 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                    ...
                    <h4 style="margin: 0; font-size: 18px; font-weight: 700; color: #333;">Deadline Compliance</h4>
                </div>
                <p style="margin: 0; color: #555; line-height: 1.6;">We specify deadlines in the contract and bear financial responsibility for violations. Regular progress reports.</p>
            </div>
            <div class="benefit-card" style="background: linear-gradient(135deg, rgba(96, 114, 79, 0.03) 0%, rgba(96, 114, 79, 0.08) 100%); border-radius: 20px; padding: 24px; border: 1px solid rgba(96, 114, 79, 0.15);">
                <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 16px;">
                    <div style="width: 52px; height: 52px; background: linear-gradient(135deg, #60724F 0%, #7a8f63 100%); border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                    ...
                    <h4 style="margin: 0; font-size: 18px; font-weight: 700; color: #333;">2 Year Warranty</h4>
                </div>
                <p style="margin: 0; color: #555; line-height: 1.6;">We provide a written warranty for all completed work. We fix any defects free of charge during the warranty period.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="content-section muted" id="process-section">
    <div class="content-container">
        <div class="section-title" style="color: #60724F; text-align: center; margin-bottom: 8px;">How We Work</div>
        <div class="section-subtitle" style="text-align: center; margin-bottom: 48px;">
            Simple and clear process from the first call to handover of the finished property
        </div>
        ...
        <div class="process-timeline">
            <div class="process-step" data-step="1">
                ...
                <div class="process-step-content">
                    <span class="process-step-badge">1-2 days</span>
                    <h4 class="process-step-title">Consultation and Property Inspection</h4>
                    <p class="process-step-desc">Free specialist visit to assess the scope of work. We discuss your wishes, measure the premises, and document the current condition.</p>
                </div>
            </div>
            ...
            <div class="process-step" data-step="2">
                ...
                <div class="process-step-content">
                    <span class="process-step-badge">2-3 days</span>
                    <h4 class="process-step-title">Estimate Preparation</h4>
                    <p class="process-step-desc">We prepare a detailed estimate broken down by work types and materials. We discuss budget optimization options without compromising quality.</p>
                </div>
            </div>
            ...
            <div class="process-step" data-step="3">
                ...
                <div class="process-step-content">
                    <span class="process-step-badge">1 day</span>
                    <h4 class="process-step-title">Contract Signing</h4>
                    <p class="process-step-desc">We sign an official contract with fixed price and deadlines. All conditions are transparent — no hidden fees.</p>
                </div>
            </div>
            ...
            <div class="process-step" data-step="4">
                ...
                <div class="process-step-content">
                    <span class="process-step-badge">as planned</span>
                    <h4 class="process-step-title">Work Execution</h4>
                    <p class="process-step-desc">An experienced team begins work. We regularly send photo and video reports. You can monitor the process remotely.</p>
                </div>
            </div>
            ...
            <div class="process-step" data-step="5">
                ...
                <div class="process-step-content">
                    <span class="process-step-badge">final</span>
                    <h4 class="process-step-title">Acceptance and Warranty</h4>
                    <p class="process-step-desc">Joint acceptance of work, addressing any issues, final cleaning. We hand over a 2-year warranty certificate.</p>
                </div>
            </div>
        </div>
        ...
        <div class="process-result">
            <div class="process-result-card">
                ...
                <div class="process-result-content">
                    <span class="process-result-label">Result</span>
                    <p class="process-result-title">Finished renovation with 2-year warranty</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="content-section hero-surface">
    <div class="content-container">
        <div class="content-hero-card" style="text-align: center; align-items: center;">
            <div class="content-pill">Start Today</div>
            <h2 style="color: #fff; font-size: clamp(24px, 3.5vw, 36px); font-weight: 800; line-height: 1.3; margin: 0;">Ready to Discuss Your Project?</h2>
            <p class="content-lead" style="text-align: center; max-width: 700px;">Leave a request for a free consultation. We will contact you within a few hours to discuss details and schedule a property inspection.</p>
            <div style="display: flex; gap: 16px; flex-wrap: wrap; justify-content: center; margin-top: 8px;">
                <a href="#callback" class="btn btn-large" style="text-decoration: none;">Get Consultation</a>
...
<!-- Contact Section -->
<?php include __DIR__ . '/contact-en.php'; ?>
