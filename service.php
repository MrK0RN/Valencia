...
<head>
    ...
    <title>Сервис под ключ | Недвижимость в Валенсии</title>
    <meta name="description" content="Полное сопровождение покупки недвижимости в Валенсии — от подбора до передачи ключей. Документы, юридическая проверка, сделка под ключ.">
...
<body>
    <div class="desktop">
        ...
        <!-- Service Content -->
        <?php include 'blocks/service-ru.php'; ?>
